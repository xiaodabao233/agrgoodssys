    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">添加农资商</h4>
            </div>
...
<!-- 农资商修改的模态框 -->
<div class="modal fade" id="agrSupplierUpdateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title">农资商修改</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    //点击全部删除，就批量删除
    $("#agrsupplier_delete_all_btn").click(function () {
        //
        var del_idstr = "";
        ...
        if (confirm("确认删除吗？")) {
            //发送ajax请求删除
            $.ajax({
                url: "${APP_PATH}/agrsupplier/" + del_idstr,
                type: "DELETE",
                success: function (result) {
                    alert(result.msg);
                    //回到当前页面
    ...
    $(document).on("click", ".edit_btn", function () {
        ...
        $("#agrsupplier_update_btn").click(function () {
            ...
            $.ajax({
                ...
                type: "PUT",
                data: $("#agrSupplierUpdateModal form").serialize(),
                success: function (result) {
                    // alert(result.msg);
                    //1、关闭对话框
                    $("#agrSupplierUpdateModal").modal("hide");
                    //2、回到本页面
                    to_page(currentPage);
                }
            });
